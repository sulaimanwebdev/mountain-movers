    ...
    <>
      ...
      <div className="mainCont py-8">
       ...
       <div className="max-w-[1000px] mx-auto">
         <div className="text-center font-bold text-[35px] mb-3">5 Tips for Planning a Long-Distance Move</div>
         ...
         <div className="flex items-center justify-center gap-3 my-5">
            <button className="rounded-full bg-[#EEFFF8] text-[#34AD82] text-[15px] px-3 py-[2px]">Moving Tips</button>
            <button className="rounded-full bg-[#EEFFF8] text-[#34AD82] text-[15px] px-3 py-[2px]">Long Distance Move</button>
         </div>
         
         <div className="flex items-center justify-between gap-2 text-[17px] font-medium text-[#9999A1] w-fit mx-auto">
         <div>By <span className="text-[#34AD82]">Author</span></div>
         <div className="w-[4px] h-[4px] rounded-full bg-[#E9E8E8]"></div>
         <div>Published 20 Jan 2023</div>
         <div className="w-[4px] h-[4px] rounded-full bg-[#E9E8E8]"></div>
         ...
         <div className="font-bold text-[25px] my-8">HOW TO PREPARE YOUR FURNITURE FOR MOVING</div>
       ...
       <div className="w-full mt-20">
         <div className="text-[23px] font-[600] text-center mb-5">You may like this post</div>
       </div>
