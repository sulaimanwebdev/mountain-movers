...
const Slider = () => {
  ...
  return (
    ...
    <Swiper 
     ...
     >
        <SwiperSlide>
            <div className="flex items-start lg4:items-center lg4:justify-between flex-col-reverse lg4:flex-row gap-5 mb-10 lg5:mb-7">
            ...
            <img src="/images/slider1.png" alt="slider1" className="w-full sm:w-[400px] mx-auto lg4:mx-0" />
            </div>
        </SwiperSlide>
