     ...
     >
        <SwiperSlide>
            ...
            <div className="max-w-[700px]">
              ...
              <div className="text-[24px] font-[600] mt-5">“I couldn't be happier with the service I received. From the initial consultation to the final move, everything was handled with care and professionalism.”</div>
            ...
            <img src="/images/slider1.png" alt="slider1" className="w-[400px]" />
            </div>
        </SwiperSlide>
