    ...
    <div className="mainCont flex items-center justify-between gap-3 sm2:gap-0">
      <div className="flex items-center gap-12">
         ...
         <div className="hidden lg2:flex items-center gap-10">
            ...
            <a href="tel:5149841522" className="bg-main transition hover:bg-[#1f7a5a] px-4 py-2 rounded-lg text-white flex items-center gap-3">
